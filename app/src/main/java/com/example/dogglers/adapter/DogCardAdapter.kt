...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val ivDogImg = view?.findViewById<ImageView>(R.id.dog_img)
        val tvDogName = view?.findViewById<TextView>(R.id.dog_name)
        val tvDogAge = view?.findViewById<TextView>(R.id.dog_age)
        val tvDogHobbies = view?.findViewById<TextView>(R.id.dog_hobbies)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val vListItem : View = LayoutInflater.from(parent.context).inflate(layoutID, parent, false)
        // TODO: Null should not be passed into the view holder. This should be updated to reflect
        //  the inflated layout.
        return DogCardViewHolder(vListItem)
    }
    ...
    override fun onBindViewHolder(holder: DogCardAdapter.DogCardViewHolder, position: Int) {
        ...
        holder.ivDogImg?.setImageResource(dog.imageResourceId)
